    ...
    <div>
      ...
      <section style={heroWrapper}>
        ...
        <div style={heroContent}>
          ...
          <button style={ctaPrimary} onClick={() => navigate("/explore")}>
            Explore Events
          </button>
        </div>
      </section>
      ...
      <section style={section}>
        <div style={container}>
          ...
          {events.length === 0 ? (
            ...
            <div style={grid}>
              {events.map(event => (
                <Link key={event.id} to={`/events/${event.id}`} style={card}>
...
const heroOverlay = {
  ...
  inset: 0,
  background:
    "linear-gradient(120deg, rgba(2,6,23,0.85), rgba(37,99,235,0.65))"
};
